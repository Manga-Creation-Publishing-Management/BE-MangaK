...
namespace Manga.Repository.Migrations
{
    ...
    [Migration("20260611080220_add Entity Reader and MangaTaskStatus (assistant can accept task), update chaptervoting and usersession")]
    partial class addEntityReaderandMangaTaskStatusassistantcanaccepttaskupdatechaptervotingandusersession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Manga.Repository.Entity.Reader", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Manga.Repository.Entity.UserSession", b =>
                {
                    ...
                    b.ToTable("UserSessions", t =>
                        {
                            t.HasCheckConstraint("CK_UserSession_Exclusive_User_Or_Reader", "(\"UserId\" IS NULL AND \"ReaderId\" IS NOT NULL) OR (\"UserId\" IS NOT NULL AND \"ReaderId\" IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Manga.Repository.Entity.ChapterVoting", b =>
                {
                    ...
                    b.HasOne("Manga.Repository.Entity.Reader", "Reader")
